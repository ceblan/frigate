...
import BisiaPlusIcon from "../icons/BisiaPlusIcon";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
type BisiaPlusUploadButtonProps = {
  video?: HTMLVideoElement | null;
  onOpen: () => void;
  onClose: () => void;
  onUploadFrame: () => void;
...
function BisiaPlusUploadButton({
  video,
  onOpen,
  onClose,
  onUploadFrame,
  ...
  return (
    ...
    >
      ...
      >
        <AlertDialogHeader>
          <AlertDialogTitle>{t("submitBisiaPlus.title")}</AlertDialogTitle>
        </AlertDialogHeader>
